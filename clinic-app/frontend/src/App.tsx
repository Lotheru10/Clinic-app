...
import AppointmentCreatePage from "./pages/appointments/AppointmentCreatePage.tsx";
    ...
    <div>
      ...
      <nav>
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: "15px", flexWrap: "wrap" }}>
            ...
            <NavLink to="/doctorsOffices/details">
              Doctor's offices details
            </NavLink>
            <NavLink to="/doctorsOffices/add">Add doctor's office</NavLink>
            <NavLink to="/doctorsOffices/delete">
              Delete doctor's office
            </NavLink>
          </div>
        </div>
      ...
      <div>
        <Routes>
          ...
          <Route
            path="/doctorsOffices/details"
            element={<DoctorsOfficeDetailsPage />}
          />
          <Route
            path="/doctorsOffices/add"
            element={<DoctorsOfficeAddPage />}
          />
          <Route
            path="/doctorsOffices/delete"
            element={<DoctorsOfficeDeletePage />}
          />
